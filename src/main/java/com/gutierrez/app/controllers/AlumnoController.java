package com.gutierrez.app.controllers;
...
import com.gutierrez.app.repositories.AlumnoRepository;
...
public class AlumnoController {
	...
	public ResponseEntity<Alumno> getTutorialById(@PathVariable("id") long id) {
	...
	public ResponseEntity<Alumno> createAlumno(@RequestBody Alumno alumno) {
		try {
			Alumno _alumno = alumnoRepository
					.save(new Alumno(alumno.getNombre(), alumno.getEdad(),alumno.getCarrera(), alumno.getSalon()));
	...
	public ResponseEntity<Alumno> updateAlumno(@PathVariable("id") long id, @RequestBody Alumno alumno) {
		...
		if (alumnoData.isPresent()) {
			...
			_alumno.setEdad(alumno.getEdad());
			_alumno.setCarrera(alumno.getCarrera());
			_alumno.setSalon(alumno.getSalon());
